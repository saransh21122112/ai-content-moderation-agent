    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 400, padding: '0 24px', position: 'relative' }}>
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: 16, fontWeight: 600, color: '#f0f0f2', margin: '0 0 4px', letterSpacing: '-0.2px' }}>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <input
                ...
                style={{
                  width: '100%',
                  background: '#08080b',
                  border: `1px solid ${state?.error ? '#ef4444' : '#1c1c24'}`,
                  borderRadius: 8,
                  padding: '10px 12px',
                  fontSize: 14,
                  color: '#f0f0f2',
                ...
                onBlur={e => { e.target.style.borderColor = state?.error ? '#ef4444' : '#1c1c24' }}
              />
              {state?.error && (
        ...
        <p style={{ textAlign: 'center', fontSize: 12, color: '#3f3f46', marginTop: 24 }}>
